...
int iptable_delete(IP_ROUTINGTABLE** table,
				   NETSIM_IPAddress dest,
				   NETSIM_IPAddress in);
int iptable_delete_by_type(IP_ROUTINGTABLE** table,
						   char* type);
int iptable_delete_by_route(IP_ROUTINGTABLE** table,
							IP_ROUTINGTABLE* route);
IP_ROUTINGTABLE* iptable_add(IP_ROUTINGTABLE** table,
							 NETSIM_IPAddress dest,
							 NETSIM_IPAddress subnet,
							 unsigned int prefix_len,
							 NETSIM_IPAddress gateway,
...
IP_ROUTINGTABLE** iptable_get_table_by_type(IP_ROUTINGTABLE* table, char* type, UINT* count);
...
bool isCorrectRoute(IP_ROUTINGTABLE** table, NETSIM_IPAddress dest, NETSIM_IPAddress src);
